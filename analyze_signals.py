...
KIND_ORDER = ['quick_blink', 'normal_blink', 'squint', 'head_shake']
KIND_COLORS = {
    'quick_blink': 'red',
    'normal_blink': 'green',
    'squint': 'orange',
...
def main():
    ...
    print(f'{"event":<14}{"n":>4}{"median peak bs":>16}{"median min EAR":>16}{"median width":>14}')
    for kind in kinds:
        s = stats[kind]
        print(f'{kind:<14}{s["n"]:>4}{s["peak_bs"]:>16.2f}{s["min_ear"]:>16.2f}'
              f'{s["width_ms"]:>11.0f} ms')
